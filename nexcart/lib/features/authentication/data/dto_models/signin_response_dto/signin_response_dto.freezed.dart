...
@override
String toString() {
  return 'SignInResponseDTO(id: $id, username: $username, email: $email, firstName: $firstName, lastName: $lastName, gender: $gender, image: $image, accessToken: $accessToken, refreshToken: $refreshToken)';
}
...
class _SignInResponseDTO extends SignInResponseDTO {
  const _SignInResponseDTO({required this.id, required this.username, required this.email, required this.firstName, required this.lastName, required this.gender, required this.image, required this.accessToken, required this.refreshToken}): super._();
